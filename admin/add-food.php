    ...
    <div class="wrapper">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <table class="table-30">
                ...
                <tr>
                    <td>
                        <label for="">Enter the food Description</label>
                        <textarea name="description" id="" cols="30" rows="10" noresize></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <label for="">Enter the Category Id</label>
                ...
                <tr>
                   <td>
                        <label for="password">Feature :</label>
                ...
                <tr>
                    <td colspan="2">
                        <input type="submit" name="submit" value="Add Food" class="btn-secondary btn-add">
                    </td>
                </tr>
            </table>
        </form>
        ...
        if(isset($_POST['submit'])) {
            ...
            if(isset($_FILES['food-image']['name'])) {
                ...
                if ($image_name != "")
                {
                    ...
                    // 2. Renaming the file
                    $image_name = "Food_type_".rand(000, 999). '.'.$ext;
                    ...
                    if($upload == false) {
                        ...
                        $_SESSION['upload'] = "<div class='error'> upload Image with failure</div>";
                        // Redirecting
            ...
            if($res == true) {
                ...
                // Insert data
                $_SESSION['add'] = "<div class='success'> Food has been Added Succesfully </div>";
